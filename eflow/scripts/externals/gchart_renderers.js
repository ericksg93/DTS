...
resultPrint = $("<div>");
  ...
  function onReady() {
        resultPrint[0].innerHTML = '<p><center><a id="Print'+extraOptions.Print_Id+'" href="' + wrapper.getChart().getImageURI() + '" target="_blank" download="'+extraOptions.title+'.jpg"></a><center></p>';
  ...
  //
	...
	/*return $.pivotUtilities.gchart_renderers_Dashboard = function(Type,Options){
		 var List_Renderers = {
      "Line Chart": makeGoogleChart("LineChart",Options),
      "Bar Chart": makeGoogleChart("ColumnChart",Options),
      "Stacked Bar Chart": makeGoogleChart("ColumnChart",Options),
      "Area Chart": makeGoogleChart("AreaChart", Options),
      "Scatter Chart": makeGoogleChart("ScatterChart",Options)
     };
	 
		 return List_Renderers[Type];
	 };
    return $.pivotUtilities.gchart_renderers = 	{
      "Line Chart": makeGoogleChart("LineChart"),
      "Bar Chart": makeGoogleChart("ColumnChart",{width: 400, height: 400}),
	 ...
	 gchart_renderers_Dashboard : function(Type,Options){
		 var List_Renderers = {
      "Line Chart": makeGoogleChart("LineChart",Options),
      "Bar Chart": makeGoogleChart("ColumnChart",Options),
      "Stacked Bar Chart": makeGoogleChart("ColumnChart",Options),
